...
Indien de productiedatum van het object exact gekend is, volg je de volgende richtlijnen:

* vul dezelfde datum in bij "van" en "tot" \(jjjj-mm-dd\)
* mm en dd zijn niet verplicht, men kan dus enkel het jaartal invoeren

  Indien de productiedatum niet gekend is, volg je de volgende richtlijnen:

* vroegst mogelijke vervaardigingsdatum bij "van" \(jjjj-mm-dd\)
* laatst mogelijke vervaardigingsdatum bij "tot" \(jjjj-mm-dd\)
